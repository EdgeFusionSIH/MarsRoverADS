        ...
        <div className="panel complexity-panel">
          ...
          <div className="panel-body">
            <div className="gauges-grid">
              ...
              <Gauge value={hw.gpu_percent || 0} label="GPU" color="var(--emerald)" />
              <Gauge value={hw.ram_percent || 0} label="RAM" color="var(--amber)" />
              <Gauge
                value={hw.solar_battery_percent || 0}
                label="SOLAR"
                color={hw.solar_battery_percent < 40 ? 'var(--red)' : 'var(--emerald)'}
                warning={hw.solar_battery_percent < 40}
              />
            </div>
